...
vi.mock('@/lib/telegram/chat/attachment/extractTelegramFileIds', () => ({
  default: vi.fn(),
}));
vi.mock('@/lib/telegram/chat/attachment/isTooBigForTelegram', () => ({
  default: vi.fn(),
...
import isTooBigForTelegram from '@/lib/telegram/chat/attachment/isTooBigForTelegram';
